...
total_query_scores = defaultdict(int)


for art_id, a in articles.iteritems():
	for supercat, score in a["supercats"].iteritems():
		total_query_scores[supercat] += score * float(a["score"])

for supercat in total_query_scores:
	total_query_scores[supercat] /= len(articles)
